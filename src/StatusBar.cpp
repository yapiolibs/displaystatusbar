...
{
// ☐
constexpr const uint8_t symbol_wifi_disconnected[] PROGMEM{ 0b11111111, 0b10000001, 0b10000001,
                                                            0b10000001, 0b10000001, 0b10000001,
                                                            0b11111111 };
// ✗
constexpr const uint8_t symbol_wifi_disabled[] PROGMEM{ 0b01000001, 0b00100010, 0b00010100,
                                                        0b00001000, 0b00010100, 0b00100010,
                                                        0b01000001 };
// 📶
constexpr const uint8_t symbol_wifi_connected_strong[] PROGMEM{ 0b00000001, 0b00000001, 0b00000101,
                                                                0b00000101, 0b00010101, 0b00010101,
                                                                0b01010101 };

// 📶
constexpr const uint8_t symbol_wifi_connected_moderate[] PROGMEM{
    0b00000000, 0b00000000, 0b00000100, 0b00000100, 0b00010100, 0b00010100, 0b01010100
};

// 📶
constexpr const uint8_t symbol_wifi_connected_weak[] PROGMEM{ 0b00000000, 0b00000000, 0b00000000,
                                                              0b00000000, 0b00010000, 0b00010000,
                                                              0b01010000 };
// 📶
constexpr const uint8_t symbol_wifi_connected_barely[] PROGMEM{ 0b00000000, 0b00000000, 0b00000000,
                                                                0b00000000, 0b00000000, 0b00000000,
                                                                0b01000000 };
// 📶
constexpr const uint8_t symbol_wifi_ap[] PROGMEM{ 0b01001001, 0b00101010, 0b00010100, 0b00001000,
...
StatusBar::StatusBar(const OperatingMode &operating_mode, Display &display)
: operating_mode(operating_mode), display(display)
{
...
void StatusBar::printWifiStatus()
{
    ...
    bool is_ap_enabled =
    WiFi.getMode() != WIFI_OFF && (WiFi.getMode() == WIFI_AP || WiFi.getMode() == WIFI_AP_STA);
    ...
    else if(is_sta_enabled)
    {
        if(is_sta_connected)
        {
            ...
            {
                display.drawBitmap<SymbolWifiConnectedModerate>(display.width() - 1 -
                                                                SymbolWifiConnectedModerate::width,
                                                                0);
            }
            else if(snr > 10)
            {
